...
await esbuild.build({
  ...
  bundle: true,
  outfile: path.join(__dirname, "dist/ninjacode.cjs"),
  // Resolve workspace packages from this repo's source so a stale or
  // cross-repo node_modules link cannot pull the wrong @ninjacode/providers.
  alias: {
